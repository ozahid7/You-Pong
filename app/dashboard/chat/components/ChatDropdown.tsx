...
import { menuChatElements } from "@/const";
import { renderIcon } from "@/utils";

const ChatDropdown = (icon: { icon: any; style: string; size: number }) => {
  return (
          ...
          {menuChatElements.map((elm) => (
            ...
            >
              {({ active }) => (
                <a
                  href={elm.href}
                  className={`py-2 px-4 min-w-[160px] border-b border-palette-grey font-body font-bold flex items-center space-x-4  ${
                    active
