...
function Map({ elements, border, background, name }: Props) {
  ...
  return (
    <div className="flex w-full s:h-[11rem] h-[6.5rem] md_:h-[12rem] xl_:h-[13rem] justify-center flex-col items-center">
      <div
      ...
      >
        <button
          ...
          className={`flex shadow-lg rounded-sm w-[90%] h-[90%] border-[6px] items-center justify-center hover:scale-110 transform-gpu btn btn-ghost`}
        >
