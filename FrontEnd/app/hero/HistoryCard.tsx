...
const HistoryCard = () => {
    return (
        <div className="flex justify-center items-center   max-w-[720px] xl:max-w-[520px] min-w-[256px] w-[90%] xl:w-[92%] h-[94%] xl:h-[90%] ">
            <MyCard type="nocorner" otherclass="max-h-full w-full flex ">
                <div className="w-full relative   h-full flex flex-col pb-2 justify-end items-center">
