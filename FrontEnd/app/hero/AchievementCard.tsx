...
const AchievementCard = () => {
  ...
  return (
      <div className="flex min-w-[240px] xl:min-w-[280px] xl:max-w-[360px] md:w-[80%] w-[90%] h-[80%] md:h-[90%] ">
          <MyCard type="nocorner" otherclass="max-h-full flex">
              <div className="w-full relative h-full flex flex-col justify-end items-end">
                  ...
                  <Tooltip
                      ...
                      place={"top-start"}
                  />
                  <div className=" flex w-full overflow-y-auto  md:h-[90%] h:h-[84%] h-[86%] space-y-20 flex-col items-center mb-2">
