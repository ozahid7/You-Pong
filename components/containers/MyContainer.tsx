...
export function MyContainer({children, withCorners,  closeModal, isModal, isLoader, costumClass}: MyContainerProps) {

    const customclass = withCorners ? "hidden" : "";
    const otherclass = withCorners ? "s:hidden" : "";
    const classname = twMerge(
        "bg-white w-full h-full flex rounded-sm relative my_scroll_orange overflow-auto",
        costumClass
    );
    return (
        <div className={classname}>
            ...
            <div className=" h-[90%] w-[90%] min-w-[20px] flex-col justify-center items-center absolute top-[50%] my_scroll_orange overflow-auto translate-y-[-50%] left-[50%] translate-x-[-50%]">
                {children}
            </div>
